...
function path() {
 ...
 function updateImage () {
  ...
  //  document.getElementById("myImage").setAttribute("style", "margin-top: 1000px;");
  //  document.getElementById("myImage").setAttribute("style", "text-align:center");
...
//  document.getElementById("myImage").setAttribute("style", "margin-top: 80px");
